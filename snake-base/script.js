...
function setup() {
  // on charge le modèle
  classifier = ml5.imageClassifier("https://teachablemachine.withgoogle.com/models/a_rPKxoPN/model.json");
...
function keyPressed() {
  switch (keyCode) {
    ...
    case 40: // 40 à flèche du bas
      goDown();
      break;
    case 37: // 40 à flèche de gauche
      goLeft();
      break;
    case 39: // 40 à flèche de droite
      goRight();
      break;
  }
}
